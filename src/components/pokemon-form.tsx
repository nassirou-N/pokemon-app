...
const PokemonForm: FunctionComponent<Props> = ({pokemon, isEditForm}) => {
  ...
  const handelSubmit = (e:React.FormEvent<HTMLFormElement>)=>{
    ...
    if(isFormValid){
      ...
      isEditForm ? editPokemon() : addPokemon();
    }
  ...
  const validateForm = () => {
    ...
    /// validator url
    if (isAddForm()) {
      const start = "https://assets.pokemon.com/asset/cms2/img/pokedex/detail/";
      const end = ".png";
              ...
              <div className="card-content">
                ...
                {isAddForm() && (
                  <div className="form-group">
                    ...
                    {form.name.error && <div className='card-panel red accent-1'>{form.picture.error}</div>}
                  </div>
                ) }
